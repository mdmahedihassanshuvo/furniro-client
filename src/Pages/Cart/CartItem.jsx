...
const CartItem = () => {
  ...
  return (
    <div className="">
      ...
      <div className="md:mx-[50px] md:py-10 grid grid-cols-4 md:gap-5">
        ...
        <div className="bg-[#ffe2d0] flex flex-col justify-evenly items-center">
          ...
          <div>
            <button className="py-2 px-4 rounded-md hover:bg-slate-400 hover:text-white font-medium text-black border border-black">
              Check Out
            </button>
          </div>
        </div>
